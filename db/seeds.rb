...
posts =
  ...
  [{ title: 'PARTY HOUSE!!! Cap HIll, you already know.', house_type: 'House', description:
    ...
    bathroom_type: "Shared", laundry: "In-unit", parking: "Garage", cats: false, dogs: true, smoking: true, user_id: 4}] # Tom Thomas
...
profiles =
  [{ title: 'Hippy Free Lovin Dude lookin for chill housemates', house_type: "[\"House\"]", description:
    ...
    min_price: 500, max_price: 700, neighborhoods: "[\"Ballard/Fremont\", \"South Lake Union\", \"Montlake/Eastlake\", \"Madrona/Leschi\", \"Capitol Hill\", \"Central District\", \"Belltown/Denny Triangle/Downtown\", \"Mount Baker\", \"Beacon Hill\", \"Phinney Ridge\"]", rooms_needed: 1, max_roommates: 10, bathroom_type: "[\"Private\", \"Shared\"]", laundry: "[\"In-unit\", \"On-site\", \"In-building\"]",
  ...
  [{ title: '23 yo professional looking for awesome flatmates', house_type: "[\"Duplex\", \"Condo\", \"Apartment\"]", description:
    ...
    min_price: 400, max_price: 1200, neighborhoods: "[\"Ballard/Fremont\"]",
  ...
  [{ title: 'Party Boi Lookin For Frat/Flat Mates to Vibe with', house_type: "[\"House\", \"Apartment\", \"Duplex\", \"Condo\"]", description:
    ...
    rooms_needed: 1, max_roommates: 10, bathroom_type: "[\"Shared\"]", laundry: "[\"In-unit\", \"On-site\", \"In-building\"]",
